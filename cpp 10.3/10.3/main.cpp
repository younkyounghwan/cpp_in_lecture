...
int main()
{
	...
	Student *std3 = new Student("Violet", 2); // student object 积己

	Teacher *tech1 = new Teacher("Prof. Hong");
	Teacher *tech2 = new Teacher("Prof. Good"); //teacher object 积己

	//composition Relationship
	Lecture lec1("Introduction to Computer Programming"); // lecture object 积己
